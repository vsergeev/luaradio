...
methods)`](0.reference-manual.md#cstructtypefactoryctype-methods) factory
...
with the [`JSONSink`](0.reference-manual.md#jsonsink). See the [LuaRadio
Reference Manual](0.reference-manual.md#objecttype) for more inherited methods
of `Object` types.
