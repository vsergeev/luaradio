...
describe("ComplexFloat32Type", function ()
    it("size", function ()
        ...
        assert.is_equal(8, ffi.sizeof(ComplexFloat32Type))
    end)
    ...
    it("operations", function ()
        ...
        -- Subtraction
        assert.is_equal(ComplexFloat32Type(1.5, -1.5), ComplexFloat32Type(3.0, 0.0) - ComplexFloat32Type(1.5, 1.5))

        -- Complex Multiplication
        assert.is_equal(ComplexFloat32Type(10, 5), ComplexFloat32Type(1, 2) * ComplexFloat32Type(4, -3))

        -- Complex Division
        assert.is_equal(ComplexFloat32Type(1, 2), ComplexFloat32Type(10, 5) / ComplexFloat32Type(4, -3))

        -- Scalar Multiplication
        assert.is_equal(ComplexFloat32Type(5, 3), ComplexFloat32Type(2.5, 1.5):scalar_mul(2))

        -- Scalar Division
        assert.is_equal(ComplexFloat32Type(2, 4), ComplexFloat32Type(3, 6):scalar_div(1.5))
        ...
        -- Complex Conjugate
        assert.is_equal(ComplexFloat32Type(1, -2), ComplexFloat32Type(1, 2):conj())
        assert.is_equal(ComplexFloat32Type(-5, 10), ComplexFloat32Type(-5, -10):conj())
