...
describe("oo helpers", function ()
    ...
    it("isinstanceof() cdata types", function ()
        assert.is_true(object.isinstanceof(types.ComplexFloat32(1, 2), types.ComplexFloat32))
        assert.is_true(object.isinstanceof(types.ComplexFloat32(1, 2), types.CStructType))
        assert.is_false(object.isinstanceof(types.ComplexFloat32(2), "number"))
        assert.is_false(object.isinstanceof(types.Float32(2), types.ComplexFloat32))
        assert.is_false(object.isinstanceof(5, types.ComplexFloat32))
        assert.is_false(object.isinstanceof(5, types.CStructType))
        assert.is_false(object.isinstanceof({}, types.ComplexFloat32))
        assert.is_false(object.isinstanceof({}, types.CStructType))

        assert.is_true(object.isinstanceof(types.Float32(1), types.Float32))
        assert.is_true(object.isinstanceof(types.Float32(1), types.CStructType))
        assert.is_false(object.isinstanceof(types.Float32(2), "number"))
        assert.is_false(object.isinstanceof(types.ComplexFloat32(1, 2), types.Float32))
        assert.is_false(object.isinstanceof(5, types.Float32))
        assert.is_false(object.isinstanceof({}, types.Float32))
    end)
end)
