...
local a8 = radio.BinaryPhaseCorrectorBlock(4000)
local b0 = radio.BandpassFilterBlock(193, {18e3, 20e3})
local b1 = radio.PLLBlock(1500.0, 19e3-100, 19e3+100, 3.0)
local b2 = radio.PLLBlock(1500.0, 19e3-100, 19e3+100, 1/16.0)
