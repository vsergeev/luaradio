...
describe("filter_utils", function ()
    ...
    it("test complex firwin functions", function ()
        jigs.assert_vector_equal(
            radio.ComplexFloat32Type.vector_from_array(filter_utils.firwin_complex_bandpass(129, {0.1, 0.3})),
            test_vectors.firwin_complex_bandpass_positive, 1e-6)
        jigs.assert_vector_equal(
            radio.ComplexFloat32Type.vector_from_array(filter_utils.firwin_complex_bandpass(129, {-0.1, -0.3})),
            test_vectors.firwin_complex_bandpass_negative, 1e-6)
        jigs.assert_vector_equal(
            radio.ComplexFloat32Type.vector_from_array(filter_utils.firwin_complex_bandpass(129, {-0.2, 0.2})),
            test_vectors.firwin_complex_bandpass_zero, 1e-6)

        jigs.assert_vector_equal(
            radio.ComplexFloat32Type.vector_from_array(filter_utils.firwin_complex_bandstop(129, {0.1, 0.3})),
            test_vectors.firwin_complex_bandstop_positive, 1e-6)
        jigs.assert_vector_equal(
            radio.ComplexFloat32Type.vector_from_array(filter_utils.firwin_complex_bandstop(129, {-0.1, -0.3})),
            test_vectors.firwin_complex_bandstop_negative, 1e-6)
        jigs.assert_vector_equal(
            radio.ComplexFloat32Type.vector_from_array(filter_utils.firwin_complex_bandstop(129, {-0.2, 0.2})),
