...
describe("composite", function ()
    ...
    it("input/output aliasing", function ()
        ...
        assert.is_true(class.isinstanceof(blk.inputs[1], pipe.AliasedInputPort))
        assert.is_true(class.isinstanceof(blk.inputs[2], pipe.AliasedInputPort))
        assert.is.equal("in1", blk.inputs[1].name)
        assert.is.equal("in2", blk.inputs[2].name)
        assert.is.equal(2, #blk.outputs)
        assert.is_true(class.isinstanceof(blk.outputs[1], pipe.AliasedOutputPort))
        assert.is_true(class.isinstanceof(blk.outputs[2], pipe.AliasedOutputPort))
