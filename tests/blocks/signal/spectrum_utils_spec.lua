...
describe("spectrum_utils", function ()
    it("test complex dft", function ()
        local dft = spectrum_utils.DFT(128, radio.types.ComplexFloat32, 'rectangular')
        jigs.assert_vector_equal(dft:dft(test_vectors.complex_test_vector), test_vectors.dft_complex_rectangular, 1e-4)

        local dft = spectrum_utils.DFT(128, radio.types.ComplexFloat32, 'hamming')
    ...
    it("test real dft", function ()
        local dft = spectrum_utils.DFT(128, radio.types.Float32, 'rectangular')
        jigs.assert_vector_equal(dft:dft(test_vectors.real_test_vector), test_vectors.dft_real_rectangular, 1e-4)

        local dft = spectrum_utils.DFT(128, radio.types.Float32, 'hamming')
    ...
    it("test complex psd", function ()
        local dft = spectrum_utils.DFT(128, radio.types.ComplexFloat32, 'rectangular', 44100)
        ...
        local dft = spectrum_utils.DFT(128, radio.types.ComplexFloat32, 'hamming', 44100)
    ...
    it("test real psd", function ()
        local dft = spectrum_utils.DFT(128, radio.types.Float32, 'rectangular', 44100)
        ...
        local dft = spectrum_utils.DFT(128, radio.types.Float32, 'hamming', 44100)
