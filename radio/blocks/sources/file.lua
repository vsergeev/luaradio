...
function FileSource:instantiate(filename, format, rate)
    local supported_formats = {
        ...
        s32le = {ctype = "format_s32_t", swap = ffi.abi("be"), offset = 2147483647.5,  scale = 1.0/2147483647.5},
        s32be = {ctype = "format_s32_t", swap = ffi.abi("le"), offset = 2147483647.5,  scale = 1.0/2147483647.5},
